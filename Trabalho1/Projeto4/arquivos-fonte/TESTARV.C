...
*	  "=costura"    - chama a função ARV_CosturaFolhasOrdemAlf( )
*
***************************************************************************/
...
/* Tabela dos nomes dos comandos de teste especí­ficos */
...
*     Efetua os diversos comandos de teste especÃ­ficos para o módulo
...
***********************************************************************/
   ...
   TST_tpCondRet TST_EfetuarComando( char * ComandoTeste )
   {
      ...
      /* Testar ARV Adicionar filho à  direita */
         ...
         else if ( strcmp( ComandoTeste , INS_DIR_CMD ) == 0 )
         {
            ...
            NumLidos = LER_LerParametros( "cci" ,
                               &ValorDado , &ChaveDada , &CondRetEsperada ) ;
            if ( NumLidos != 3 )
            {
               return TST_CondRetParm ;
            } /* if */
            ...
            return TST_CompararInt( CondRetEsperada , CondRetObtido ,
                                    "Retorno errado inserir Ã  direita." );
	 ...
	 /* Testar ARV Costura Folhas da árvore alfabeticamente */
		 ...
		 else if ( strcmp( ComandoTeste , COSTURA_CMD ) == 0 )
         {
            ...
            CondRetObtido = ARV_CosturaFolhasOrdemAlf( ) ;

            return TST_CompararInt( CondRetEsperada , CondRetObtido ,
                                    "Retorno errado ao costurar folhas" ) ;

         } /* fim ativa: Testar ARV Costura Folhas da árvore alfabeticamente */
		

      return TST_CondRetNaoConhec ;

   } /* Fim função: TARV Efetuar operações de teste especí­ficas para árvore */
